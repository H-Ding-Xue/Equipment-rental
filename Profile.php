...
$profileInfo = $user->viewProfile($_SESSION["ID"]);
echo '<div class = "container mt-3 center">';
echo '<table class = "table table-hover">';
echo'<tr>';
echo'<th>ID</th>';
echo'<td>'.$profileInfo[0].'</td>';
echo'</tr>';

echo'<tr>';
echo'<th>Name</th>';
echo'<td>'.$profileInfo[1].'</td>';
echo'</tr>';

echo'<tr>';
echo'<th>Surname</th>';
echo'<td>'.$profileInfo[2].'</td>';
echo'</tr>';

echo'<tr>';
echo'<th>Phone</th>';
echo'<td>'.$profileInfo[3].'</td>';
echo'</tr>';

echo'<tr>';
echo'<th>Email</th>';
echo'<td>'.$profileInfo[4].'</td>';
echo'</tr>';

echo'<tr>';
echo'<th>Type</th>';
echo'<td>'.$profileInfo[5].'</td>';
echo'</tr>';
echo '</table>';
echo '</div>';
?>
